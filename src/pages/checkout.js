...
//    step2.style.border="1px solid grey"
//    step3.style.color="black"
//    step3.style.border="1px solid grey"
          ...
          <div id='first' className='form-first'>
            ...
            <form>
              <div className='form'>
                ...
                <p> <input type="radio" name="who" />I'm the main guest</p>
                <p><input type="radio" name="who" /> I'm booking for someone else</p>
...
<input type="time" name="date"/>
 | 
- Time is for KIM HOTEL time zone
                </p>
